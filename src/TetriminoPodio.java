...
public class TetriminoPodio extends Tetrimino {  
	...
	public Bloque[] rotar(){
		...
		switch(orientacion){
		case 0:{
			if(grilla[x][y-1].obtenerColor()!=null || grilla[x][y+1].obtenerColor()!=null || grilla[x+1][y].obtenerColor()!=null)
				return null;
		...
		case 90:{
			if(grilla[x+1][y].obtenerColor()!=null || grilla[x-1][y].obtenerColor()!=null || grilla[x][y+1].obtenerColor()!=null)
				return null;
